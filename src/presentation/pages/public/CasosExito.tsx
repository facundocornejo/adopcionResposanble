...
import { CasoExitoCard } from '@/presentation/components/casosexito'
import api from '@/infrastructure/api/axios-client'
import type { CasoExito } from '@/domain/entities/success-case'

// Tipo para organización con casos
interface OrganizacionConCasos {
  id: number
  nombre: string
  slug: string
 ...
 */
function CasosExito() {
  const [organizaciones, setOrganizaciones] = useState<OrganizacionConCasos[]>([])
  ...
  const fetchCasosExito = async () => {
    try {
      setLoading(true)
      const response = await api.get<{ success: boolean; data: { organizaciones: OrganizacionConCasos[] } }>('/api/casos-exito')
  ...
  return (
    <div className="min-h-screen bg-cream">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-terracotta-600 to-terracotta-800 text-white py-16">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            {totalCasos > 0 && (
              <div className="inline-flex items-center gap-2 bg-white/20 px-6 py-3 rounded-xl">
                ...
                <span className="text-terracotta-100">
            ...
            <div className="max-w-md mx-auto mb-10">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 rounded-xl border border-brown-200 focus:ring-2 focus:ring-terracotta-500 focus:border-transparent"
                />
              </div>
            </div>
          )}
          ...
          {error && (
            <div className="text-center py-20">
              ...
              <button
                ...
                className="mt-4 text-terracotta-600 hover:underline"
              >
                Intentar de nuevo
              </button>
            </div>
