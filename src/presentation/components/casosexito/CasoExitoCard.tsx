...
export interface CasoExitoCardProps {
  caso: CasoExito
}
 ...
 */
function CasoExitoCard({ caso }: CasoExitoCardProps) {
      ...
      >
        ...
        <div className="relative aspect-square overflow-hidden">
          ...
          <div className="absolute top-3 right-3">
            <span className="inline-flex items-center gap-1 px-3 py-1 bg-estado-adoptado text-white text-xs font-medium rounded-full">
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="flex items-center gap-3 mb-4">
                <span className="inline-flex items-center gap-1 px-3 py-1 bg-sage-100 text-sage-700 text-sm font-medium rounded-full">
